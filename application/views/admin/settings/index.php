...
<div class="tab-content">
		...
		<div class="pull-right col-md-6">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					...
					<?php 
						if(!defined('CURLOPT_IPRESOLVE')) echo '<span class="help-block" style="color: #E02A15;">Your server not support \'CURLOPT_IPRESOLVE\' facebook API.</span>';
					?>
				</div>
			</div>
	...
	<div style=" height: 520px;overflow: auto;" class="tab-pane" id="language">
		...
		<div class="pull-right">
			<a href="<?php echo site_url('admin/settings/languagedefault'); ?>" class="btn btn-default btn-sm" style="margin: 0px 5px 10px;" onclick="return confirm('<?php echo lang('settings_lang_save_language_default_confirm_msg');?>');"><?php echo lang('settings_lang_save_language_default_btn');?></a>
			<a id="save_language" data-loading-text="Saving" href="javascript:void(0)" class="btn btn-primary btn-sm"><?php echo lang('settings_lang_save_language_btn');?></a>
		</div>
...
<script type="text/javascript">
	...
	function productImg(images)
	{
		if(images.length > 0)
		{
			var e = jQuery('#shop-logo');			
			if(e.children('img').length > 0)
				e.children('img').attr('src', images[0]);
			else
				e.append('<img width="60" src="'+images[0]+'" class="pull-left box-image" style="width: 80px;" alt="" width="100" />');
