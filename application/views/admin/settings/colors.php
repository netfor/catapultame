					...
					<?php if($colors)foreach ($colors as $color) { ?>
						<tr>
							<td class="center">
								<div class="checkbox-table">
									<label>
										<input type="checkbox" name="checkb[]" class="checkb" value="<?php echo $color->id; ?>">
									</label>
								</div>
							</td>
							...
							<td class="center"><?php if ($color->published == 1) { ?>					   
									<a class="btn btn-success btn-xs tooltips action" href="javascript:void(0);" data-original-title="<?php echo lang('click_unpublish');?>" data-placement="top" rel="unpublish" data-id="<?php echo $color->id; ?>" data-flag="1"><?php echo lang('publish'); ?></a>
								<?php } else { ?>
							...
							<td class="center">
								<div class="visible-md visible-lg hidden-sm hidden-xs">
									<a href="javascript:void(0);" rel="edit" class="btn btn-teal tooltips" data-placement="top" data-original-title="<?php echo lang('edit');?>" onclick="UIModals.init('<?php echo site_url(); ?>admin/settings/edit/colors/<?php echo $color->id;?>')">
