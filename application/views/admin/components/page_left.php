		...
		<ul class="main-navigation-menu">
			...
			<li <?php if($segments[2] == 'settings') echo 'class="active open"' ?>>
				...
				<ul class="sub-menu">
					...
					<li <?php if(isset($segments[3]) && $segments[3] == 'info') echo 'class="active open"' ?>>
						<a href="<?php echo site_url("admin/settings/info"); ?>">
							<span class="title"><?php echo lang('page_left_admin_info');?></span>
						</a>
					</li>
				</ul>
			</li>
