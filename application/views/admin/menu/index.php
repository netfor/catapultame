...
<div class="row">
	<div class="col-md-4 text-left">
		...
		<?php if($menu_id > 0){ ?>
			<a href="<?php echo site_url('admin/menu/delete/'.$menu_id); ?>" class="btn btn-danger" onclick="return confirm('<?php echo lang('menu_delete_confirm_msg'); ?>')"><?php echo lang('menu_remove_menu');?></a>
		<?php } ?>
	</div>
...
<span class="help-block"><?php echo lang('menu_edit_help');?><a href="<?php echo site_url('admin/menu/index'); ?>"><?php echo lang('menu_add_new_menu');?></a></span>
<hr/>
