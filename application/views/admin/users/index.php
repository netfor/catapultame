			...
			<tbody>
				<?php if (count($users) != '') foreach ($users as $user) { ?>
						<tr>
								...
								<div class="checkbox-table">
									<label>
										<?php if ($user->id == $this->user['id']) { ?>
											<input type="checkbox" class="checkb" value="" disabled="">
										<?php }else{ ?>
							...
							<td class="center">
								<?php if ($user->id == $this->user['id']) { ?>	
									<a href="javascript:void(0);" class="btn btn-default btn-xs"><?php echo lang('unblock'); ?></a>
								<?php }elseif($user->block == 1) { ?>					   
									<a href="<?php echo site_url(); ?>admin/users/unblock/<?php echo $user->id; ?>" class="btn btn-danger btn-xs tooltips" data-original-title="<?php echo lang('user_click_unblock');?>" data-placement="top" ><?php echo lang('block'); ?></a>
								<?php } else { ?>
									<a href="<?php echo site_url(); ?>admin/users/block/<?php echo $user->id; ?>" class="btn btn-success btn-xs tooltips" data-original-title="<?php echo lang('user_click_block');?>" data-placement="top" ><?php echo lang('unblock'); ?></a>
								<?php } ?>
							</td> 
