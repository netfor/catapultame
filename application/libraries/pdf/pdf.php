...
class Pdf
{
	...
	function createPdf($file_name, $data=array())
	{
		...
		$html .= '<table cellpadding="4" style="font-family: nimbussanl; color: #333333; font-size: 8px;">
					<tr>
						...
						<td style="width: 30%;">
							<h1 style="text-align: center; margin-bottom: 20px; font-size: 24px; color: #f0f0f0;">'.$lang['title'].'</h1>
						</td>
		...
		if($data['logo'] != '')
		{
			$html .= '<img src="'.base_url($data['logo']).'" style="width: 110px; height: 40px;"/><br />';
				...
				<table cellpadding="4" style="font-family: nimbussanl; color: #333333; font-size: 8px; width: 100%;">
					...
					$html .= '
						<tr>
							<td colspan="9" style="text-align: right; border: 0.3px solid #ccc; ">'.$lang['shipment_fee'].':';
							if (count($data['shipping'])) { 
								$html .= '
								<br><small>'.$lang['shipping_method'].': <a href="'.site_url().'"><strong>'.$data['shipping']->title.'</strong></a></small>
					...
					<tr>
						<td colspan="9" style="text-align: right; border: 0.3px solid #ccc; ">'.$lang['payment_fee'].':';
						if (count($data['payment'])) {							
							$html .= '
							<br><small>'.$lang['payment_method'].': <a href="'.site_url().'"><strong>'.$data['payment']->title.'</strong></a></small>
					...
					<tr>
						<td colspan="9" style="text-align: right; border: 0.3px solid #ccc; ">'.$lang['discount'].':';
	...
	function fronEndPdf($file_name, $data=array(), $lang = array())
	{
		$pdf = new TCPDF($this->orientation, $this->unit, $this->page_fomat, true, $this->unicode, false);
		...
		$html .= '<table cellpadding="4" style="font-family: nimbussanl; color: #333333; font-size: 8px;">
					<tr>
						<td style="width: 35%;"></td>
						<td style="width: 30%;">
						<h1 style="text-align: center; margin-bottom: 20px; font-size: 24px; color: #f0f0f0;">'.$this->language('invoice', $lang).'</h1>
						</td>
						<td colspan="2" style="text-align: right; width: 35%;">';
		if($data['logo'] != '')
		{
			$html .= '<img src="'.base_url($data['logo']).'" style="width: 110px; height: 40px;"/><br />';
					...
					<tr>
						...
						<td style="width: 20%;"></td>
						<td colspan="2" style="text-align: right; width: 40%;">
							<strong style="font-size: 11.5px; line-height: 2px;">'.$this->language('user_order_number', $lang).' #'.$data['order_number'].'</strong>
						</td>
					</tr>
					...
					<tr>
						<td style="width: 20%;"></td>
						<td style="width: 22%; text-align: right;">
							'.$this->language('date', $lang).'<br />
							'.$this->language('date_ship_by', $lang).'<br />
							'.$this->language('cart_shipping', $lang).'
						</td>
						<td style="width: 18%;">
							<b>'.$data['date'].'</b><br />
							<b>'.$data['date_ship'].'</b><br />
					...
					<tr style="background-color: #F7F7F9; color: #333333; ">
						<td style="width: 40%;">
							<strong>'.$this->language('billing_address', $lang).'</strong>
						</td>
						<td style="width: 20%;"></td>
						<td style="width: 40%;">
							<strong>'.$this->language('shipping_address', $lang).'</strong>
						</td>
					</tr><br />
						...
						if(is_array($data['billing']))
						{
							$html .= '
								<table>
									...
									<tr>
										<td>'.$this->language('user_username', $lang).'</td>
										<td>
											<a href="'.site_url().'" title="'.$data['billing']['name'].'">
												'.$data['billing']['username'].'
											</a>
									...
									<tr>
										<td>'.$this->language('user_email', $lang).':</td>
										<td>'.$data['billing']['email'].'</td>
									</tr>
								</table>';
						}
				...
				<table cellpadding="4" style="font-family: nimbussanl; color: #333333; font-size: 8px; width: 100%;">
					<tr style="text-align: center; background-color: #F7F7F9; color: #333333;">
						<td style="width: 18%; border: 0.3px solid #ccc;">
							<span style="font-size: 4px;"><br/></span>
							<strong>'.$this->language('name', $lang).'</strong>
						</td>
						<td style="width: 6%; border: 0.3px solid #ccc;">
							<span style="font-size: 4px;"><br/></span>
							<strong>'.$this->language('sku', $lang).'</strong>
						</td>
						<td style="width: 14%; border: 0.3px solid #ccc;">
							<strong>'.$this->language('status', $lang).'</strong>
						</td>
						<td style="width: 8%; border: 0.3px solid #ccc;">
							<strong>'.$this->language('product_price', $lang).'</strong>
						</td>
						<td style="width: 6%; border: 0.3px solid #ccc;">
							<strong>'.$this->language('print_price', $lang).'</strong>
						</td>
						<td style="width: 7%; border: 0.3px solid #ccc;">
							<strong>'.$this->language('clipart_price', $lang).'</strong>
						</td>
						<td style="width: 9%; border: 0.3px solid #ccc;">
							<strong>'.$this->language('product_attributes', $lang).'</strong>
						</td>
						<td style="width: 8%; border: 0.3px solid #ccc;">
							<span style="font-size: 4px;"><br/></span>
							<strong>'.$this->language('quantity', $lang).'</strong>
						</td>
						<td style="width: 15%; border: 0.3px solid #ccc;">
							<span style="font-size: 4px;"><br/></span>
							<strong>'.$this->language('option', $lang).'</strong>
						</td>
						<td style="width: 9%; border: 0.3px solid #ccc;">
							<span style="font-size: 4px;"><br/></span>
							<strong>'.$this->language('total', $lang).'</strong>
						</td>
					</tr>';
					...
					$html .= '
						<tr>
							<td colspan="9" style="text-align: right; border: 0.3px solid #ccc; ">'.$this->language('shipment_fee', $lang).':';
							if (count($data['shipping'])) { 
								$html .= '
								<br><small>'.$this->language('cart_shipping_method', $lang).': <a href="'.site_url().'"><strong>'.$data['shipping']->title.'</strong></a></small>
								<br><small>'.$data['shipping']->description.'</small>';
					...
					<tr>
						<td colspan="9" style="text-align: right; border: 0.3px solid #ccc; ">'.$this->language('payment_fee', $lang).':';
						if (count($data['payment'])) {							
							$html .= '
							<br><small>'.$this->language('cart_payment_method', $lang).': <a href="'.site_url().'"><strong>'.$data['payment']->title.'</strong></a></small>
							<br><small>'.$data['payment']->description.'</small>';
						}
					$html .= '
						</td>
					...
					<tr>
						<td colspan="9" style="text-align: right; border: 0.3px solid #ccc; ">'.$this->language('cart_discount', $lang).':';
						if (count($data['discounts'])) {							
							$html .= '<br><small>'.$data['discounts']->name.': <a href="'.site_url().'"><strong>
							'.$data['discounts']->code.'</strong></a></small>';
						}
					...
					{ 
						$html .= '
							<table style="font-family: nimbussanl; color: #333333; font-size: 8px; font-weight: bold;">
								<tr>
									<td style="text-align: center; width: 40%;">';
									$html .= $this->language($key.'_legend', $lang).'</td>
									<td></td>
								</tr>
								<tr>
									<td>';
									...
									$subtable .= '<table>';
										foreach($vector as $value){
											...
											<tr>
												...
												if(isset($value['type'])){
													$subtable .= '<label>';
													$subtable .= $this->language('design_'.$value['type'].'_label', $lang).'</label>';
												}
												$subtable .= '
												</td>
												<td colspan="2">';
												...
												if($k != 'text' && $k != 'zIndex' && $k != 'type' && $k != 'svg' && $k != 'outlineC' && $k != 'outlineW' && $k != 'title' && $k != 'file_name' && $k != 'file' && $k != 'thumb' && $k != 'url' && $k != 'change_color'){
													$subtable .= '
														<tr>
															<td></td>';
															if($k == 'fontFamily')
																$subtable .= '<td>'.$this->language($k, $lang).'</td><td><a target="_blank" href="http://www.google.com/fonts/specimen/'.str_replace(' ', '+', $v).'" title="Click to download this font">'.$v.'</a></td></tr>';
															else
																$subtable .= '<td>'.$this->language($k, $lang).'</td><td>'.$v.'</td></tr>';
												}else if(($k == 'outlineC' || $k == 'outlineW') && $v != 'none'){
													$subtable .= '
														<tr>
															<td></td>';
	...
	function language($lang, $data = array())
	{
		if(isset($data[$lang]))
			return $data[$lang];
		else
